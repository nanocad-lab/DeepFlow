...
class AreaCalculation:
    ...
    def totArea(self,flops,dram_bw,network_bw,l2_mem):
        flopArea = flops*self.area_per_flop 
        ##Synth Results for 4x4 Mat Mul: 1.95 TOps/mm2 @1.2mW/op
        l2Area = l2_mem*self.L2_area_per_byte
        IOArea = network_bw*self.networkIO_area_per_GBps + dram_bw*self.dramIO_area_per_GBps

        totArea = flopArea + l2Area + IOArea
        return totArea
