...
#define PARM_flit_width		640	/* flit width in bits */

/* virtual channel parameters */
#define PARM_v_class        1   /* # of total message classes */
#define PARM_v_channel		7	/* # of virtual channels per virtual message class*/
...
/* crossbar parameters */
#define PARM_crossbar_model	TRISTATE_CROSSBAR	/* crossbar model type MATRIX_CROSSBAR, MULTREE_CROSSBAR, or TRISTATE_CROSSBAR (only for Orion3.0)*/ 
...
#define PARM_in_buf_set		10	         /*default 2 */
#define PARM_in_buf_rport	2		/* # of read ports default 1 */
