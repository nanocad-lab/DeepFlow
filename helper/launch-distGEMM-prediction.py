...
def create_sbatch_command(t, N, kp1, kp2, m, n, k, exp_dir, exp_config):
  ...
  if t == 'RC':
    ...
    out_dir = "{}/{}/{}_N{}_K{}_m{}_n{}_k{}".format(exp_dir, exp_config, t, N, kp1, m, n, k)
  else:
...
num_gpus = [1, 2, 4, 8]
exp_dir = '/mnt/home/newsha/baidu/developement/MechaFlow/validation/results/predictions/gemm/v100/parallel'
configs = ["v100_tensorcore_enabled_half_precision"] #, "v100_tensorcore_disabled_half_precision", "v100_tensorcore_disabled_float_precision"]
