...
################### Packaging SiIF
exp_name='packaging-batch4096-packSiIF-tech14-worker64-wafer1-' + current_time
...
################### Packaging MCM
exp_name='packaging-batch4096-packMCM-tech14-worker64-wafer16-' + current_time
exp_dir='/mnt/scratch/newsha/MechaFlow/' + exp_name
...
################### Packaging Volta
exp_name='packaging-batch4096-packVolta-tech14-worker64-wafer64-' + current_time
exp_dir='/mnt/scratch/newsha/MechaFlow/' + exp_name
